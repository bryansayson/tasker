...
app.controller('taskController', ["requestProcessor", "$scope", "$http", function(requestProcessor, $scope, $http) {
...
app.controller('assigneeController', ["requestProcessor", "$scope", "$http", function(requestProcessor, $scope, $http) {
    var httpServer = requestProcessor.processor;
    // grab assignees
